...
NODE_ENV | :white_check_mark: | :white_check_mark: | We support resolving modules according to `NODE_PATH`.When set to `src`, this lets you use absolute paths in imports inside large monorepos.See [issues/253](https://github.com/facebookincubator/create-react-app/issues/253)
